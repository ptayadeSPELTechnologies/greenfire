...
<head>
	...
	.bookcontainer{
		...
		margin-left:auto;
  		margin-right:auto;
    background-image:url("/greenfire/images/MersctheCoverCenter.png");
...
<body>
    ...
    <section id="content" >
           ...
           <div class="bookcontainer" align="center">
           ...
           <!-- <div>
            ...
            <div>-->
              ...
              <img src="/greenfire/images/chapter1unlocked.png" />
    ...
    <table class='miniLoqTable' align='center' border='0' class='loq'>
        ...
        <tr>
          <td class='bar' align='center'>
              <textarea  onkeyup='pressListener(event)' onmouseup='this.onkeyup()' id='loquacious' cols='45' rows='12' class='locbox'></textarea>
          </td>
        </tr>
        <tr>
          <td class='bar'>
