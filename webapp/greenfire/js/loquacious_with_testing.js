    ...
    function runprog() {
        ...
        (Sk.TurtleGraphics || (Sk.TurtleGraphics = {})).target = 'mycanvas';
         ...
         myPromise.then(function(mod) {
            	 ...
            	 document.getElementById("output"+no).innerHTML = mypre.innerHTML;
                 spokenWord=punct(mypre.innerHTML);
                 //spokenWord=spokenWord.replace("\n", " , ");
                 console.log(spokenWord);
             
                 // UNCOMMENT this
                 meSpeak.speak("The program output is, "+spokenWord, {}, function() {
                  checkit();
                 });  
                //checkit();
             ...
             function(err) {
                 ...
                 setCursorPosition(document.getElementById('loquacious'+no), lineNum);
              });
         }; 
}
...
*/             
function pressListener(event, id) {
    ...
    if (key == 38 || key == 40) {                    
        var cursorPos = getCursorLineNumber(id);
...
/**
* This function is used to warn user of infinite loop
* @function exitScript 
*/
/*function exitScript() {
    if (compiled == false)
         console.log('Check if program has a infinite loop. Refresh the window, then correct and rerun your program.');
}
*/
