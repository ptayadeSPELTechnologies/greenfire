	     ...
	     try{
	    	 ...
	    	 if(chapter_unlocked<9){
		       ...
		       for(int i=1;i<chapter_unlocked+1;i++) {	
		         ...
		         str+="<input type='hidden' id='ch"+i+"' value='"+prev+"'/></div>";
				...
				if(chapter_unlocked==3){
		          ...
		          str="<div class='title2'>Fourth Question</div>";
		          prev++;
		      	}

		      	if(chapter_unlocked==5){
		          str="<div class='title2'>Fifth Question</div>";
		          prev++;
		      	}
		      ...
		      str="<div class='editor'>";
		    	...
		    	//code for loquacious    
	               ...
	               "<table class='miniLoqTable' align='center' border='0' class='loq'>"+
	                 "<tr>"+
	                    " <th class='bar1' ><p class='logo'>Loquacious</p> <input type='hidden' id='editorPageNumber' value='"+prev+"'/></th>"+
	                 "</tr>"+
	                 "<tr>"+
