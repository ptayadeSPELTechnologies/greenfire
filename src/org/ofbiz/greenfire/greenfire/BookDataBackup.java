	...
	public static String doGet(HttpServletRequest request, HttpServletResponse response) throws IOException  {
		// Set the response message's MIME type
	     ...
	     try{
	    	 ...
	    	 String html="<input type='hidden' id='chapterunlock' value='"+chapter_unlocked+"'/>";
	    	 ...
	    	 if(chapter_unlocked<9){
		       ...
		       for(int i=1;i<chapter_unlocked+1;i++) {	
		         ...
		         str="<div class='title2 custompage'>"+title+"</div>";
			 ...
			 //main page div     
		      str="<div class='editor custompage'>";
